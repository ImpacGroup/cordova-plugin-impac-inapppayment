...
ImpacInappPayment.prototype.manageSubscriptions = function(successCallback, errorCallback) {
  cordova.exec(successCallback, errorCallback, 'ImpacInappPayment', 'manageSubscriptions', [])
}
